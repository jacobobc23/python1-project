...
class RegisterContactDesign:
    def __init__(self):
        self.init_window()

    def init_window(self):
        self.window = tk.Tk()
        self.window.title('Agregar contacto')
    ...
    def init_components(self):
        ...
        lbl_title = tk.Label(title_panel, text='Agregar contacto', font=('Segoe UI', 18, BOLD), bg='white', pady=30)
        ...
        btn_add = tk.Button(form_panel, text='AGREGAR', font=('Segoe UI', 10, BOLD), bg='blue', fg='white', padx=30, bd=0, cursor='hand2', command=self.add_contact)
